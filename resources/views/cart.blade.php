                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="heading">
                            ...
                            <h3>{{ trans('cart.OR') }}</h3>
                            <a class="btn btn-default check_out" href=" {{ route('checkout') }}"> {{ trans('cart.checkout') }}</a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="total_area">
                            <ul>
                                <li> {{ trans('cart.cart_sub_total') }}<span> {{ Cart::subtotal() }} {{ trans('cart.vnd') }}</span></li>
                                <li> {{ trans('cart.eco_tax') }} <span> {{ Cart::tax() }}</span></li>
                                <li> {{ trans('cart.ship') }} <span> {{ trans('cart.ship_cost') }}</span></li>
                                <li> {{ trans('cart.total') }} <span>{{ Cart::total() }} {{ trans('cart.vnd') }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
